<aside
    ...
    <div class="h-19.5">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="javascript:;" target="_blank">
            ...
            <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">Beasiswaku</span>
        </a>
    </div>
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            <li class="mt-0.5 w-full">
                <a href="index"
                    class="py-2.7 text-sm my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors {{ request()->is('index') ? 'bg-white shadow-soft-xl rounded-lg font-semibold text-slate-700' : 'text-slate-500' }}">

                    <div
                        class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg {{ request()->is('index') ? 'bg-gradient-to-tl from-purple-700 to-pink-500 text-white' : 'bg-white text-slate-700' }}">
            ...
            <li class="mt-0.5 w-full">
                <a href="pendaftar"
                    class="py-2.7 text-sm my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
        {{ request()->is('pendaftar') ? 'bg-white shadow-soft-xl rounded-lg font-semibold text-slate-700' : 'text-slate-500' }}">

                    <div
                        class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg
            {{ request()->is('pendaftar')
                ...
                : 'bg-white text-slate-700' }}">
                        ...
                        <svg width="12px" height="12px" viewBox="0 0 42 42" xmlns="http://www.w3.org/2000/svg">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="currentColor" fill-rule="nonzero">
                                <g transform="translate(-1869,-293)">
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors {{ request()->is('userpengajuan') ? 'bg-white shadow-soft-xl rounded-lg font-semibold text-slate-700' : 'text-slate-500' }}"
                    href="{{ route('userpengajuan') }}">
                    <div
                        class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg {{ request()->is('userpengajuan') ? 'bg-gradient-to-tl from-purple-700 to-pink-500 text-white' : 'bg-white text-slate-700' }} bg-center fill-current stroke-0 text-center xl:p-2.5">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>credit-card</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-2169.000000, -745.000000)" fill="currentColor"
                                    fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
