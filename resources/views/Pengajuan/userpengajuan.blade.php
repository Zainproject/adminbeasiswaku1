                                ...
                                <div
                                    ...
                                    <div class="flex flex-wrap -mx-3">
                                        <div class="flex items-center flex-none w-1/2 max-w-full px-3">
                                            <h6 class="mb-0">Pengajuan Beasiswa</h6>
                                        </div>
                                ...
                                <div class="flex-auto p-4 pt-6">
                                    <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                                        @foreach ($pengajuan as $index => $p)
                                            <li
                                                class="relative flex p-6 mb-2 border-0 {{ $index == 0 ? 'rounded-t-inherit' : '' }} {{ $index == count($pengajuan) - 1 ? 'rounded-b-inherit' : '' }} rounded-xl bg-gray-50">
                                                <div class="flex flex-col">
                                                    <h6 class="mb-4 leading-normal text-sm">
                                                        {{ $p->pendaftar->nama_lengkap }}</h6>
                                                    <span class="mb-2 leading-tight text-xs">Institution:
                                                        <span
                                                            class="font-semibold text-slate-700 sm:ml-2">{{ $p->pendaftar->instansi }}</span></span>
                                                    <span class="mb-2 leading-tight text-xs">Email Address:
                                                        <span
                                                            class="font-semibold text-slate-700 sm:ml-2">{{ $p->pendaftar->email }}</span></span>
                                                    <span class="mb-2 leading-tight text-xs">Tanggal Lahir:
                                                        <span
                                                            class="font-semibold text-slate-700 sm:ml-2">{{ $p->pendaftar->tetala ? \Carbon\Carbon::parse($p->pendaftar->tetala)->format('d/m/Y') : '-' }}</span></span>
                                                    <span class="mb-2 leading-tight text-xs">Alamat:
                                                        <span
                                                            class="font-semibold text-slate-700 sm:ml-2">{{ $p->pendaftar->alamat ?: '-' }}</span></span>
                                                    <span class="mb-2 leading-tight text-xs">Beasiswa yang Dipilih:
                                                        <span
                                                            class="font-semibold text-slate-700 sm:ml-2">{{ $p->beasiswa->nama_beasiswa }}</span></span>
                                                    <span class="mb-2 leading-tight text-xs">Penyedia:
                                                        <span
                                                            class="font-semibold text-slate-700 sm:ml-2">{{ $p->beasiswa->penyedia }}</span></span>
                                                    <span class="leading-tight text-xs">Surat:
                                                        @if ($p->pendaftar->surat)
                                                            <a href="{{ asset('storage/' . $p->pendaftar->surat) }}"
                                                                target="_blank"
                                                                class="font-semibold text-blue-600 hover:text-blue-800 sm:ml-2">Lihat
                                                                Surat</a>
                                                        @else
                                                            <span class="font-semibold text-slate-700 sm:ml-2">-</span>
                                                        @endif
                                                    </span>
                                                </div>
                                                <div class="ml-auto text-right">
                                                    <a class="relative z-10 inline-block px-4 py-3 mb-0 font-bold text-center text-transparent uppercase align-middle transition-all border-0 rounded-lg shadow-none cursor-pointer leading-pro text-xs ease-soft-in bg-150 bg-gradient-to-tl from-red-600 to-rose-400 hover:scale-102 active:opacity-85 bg-x-25 bg-clip-text"
                                                        href="{{ route('pengajuan.destroy', $p->id) }}"
                                                    ...
                                                    <a class="inline-block px-4 py-3 mb-0 font-bold text-center uppercase align-middle transition-all bg-transparent border-0 rounded-lg shadow-none cursor-pointer leading-pro text-xs ease-soft-in bg-150 hover:scale-102 active:opacity-85 bg-x-25 text-slate-700"
                                                        href="{{ route('pengajuan.edit', $p->id) }}"><i
